if (localStorage.getItem('userdetails') === null) {  
    ...
    // we convert a JS object to a string using JSON.stringify - we are being expedient!
    ...
    // if localstorage variable userdetails is already created - load it to JS oject. JSON.parse turns it back into an javascript object
